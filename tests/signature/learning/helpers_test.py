...
def test_extract_names():
    senders_names = {
        ...
        ("Jay Rickerts <eCenter@example.com>@EXAMPLE <XXX-Jay+20Rickerts" "+20+3CeCenter+40example+2Ecom+3E+40EXAMPLE@EXAMPLE.com>"): [
            "Jay",
            "Rickerts",
        ],
        ...
        ('"Ridthauddin B A Rahim \(DD/PCSB\)"' " <ridthauddin_arahim@example.com>"): ["Ridthauddin", "Rahim"],
        ('"Boland, Patrick \(Global Xxx Group, Ireland \)"' " <Patrick.Boland@example.com>"): ["Boland", "Patrick"],
        '"Mates Rate \(Wine\)" <amen@example.com.com>': ["Mates", "Rate", "Wine"],
        ('"Morgan, Paul \(Business Xxx RI, Xxx Xxx Group\)"' " <paul.morgan@example.com>"): ["Morgan", "Paul"],
        '"David DECOSTER \(Domicile\)" <decosterdavid@xxx.be>': ["David", "DECOSTER", "Domicile"],
    }

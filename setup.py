...
class InstallCommand(install):
    ...
    def finalize_options(self):
        ...
        if self.no_ml:
            ...
            for not_required in ["numpy", "scipy", "scikit-learn>=1.0.0", "joblib"]:
                if not_required in dist.install_requires:
...
setup(
    ...
    long_description="Mailgun library to extract message quotations and signatures. See README.rst for more details.",
    author="Mailgun Inc.",
